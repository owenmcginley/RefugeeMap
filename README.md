...
This R Shiny application visualizes global refugee data on an interactive map. The app allows users to explore the number of refugees originating from different countries over time. The visualization can be easily accessed on [shinyapps.io](https://owenmcginley.shinyapps.io/RefugeeMap/).
